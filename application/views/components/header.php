...
<head>
  ...
  <!-- START: Page CSS-->
  <link rel="stylesheet" href="<?= base_url() ?>dist/vendors/chartjs/Chart.min.css">
  <!-- END: Page CSS-->
  ...
  <link rel="stylesheet" href="<?= base_url() ?>dist/vendors/jquery-jvectormap/jquery-jvectormap-2.0.3.css">
  <!-- END: Page CSS-->
        ...
        <li class="dropdown active"><a href="#"><i class="icon-organization mr-1"></i> Layout</a>
          <ul>
            <li class="dropdown active"><a href="#"><i class="icon-options"></i>Horizontal</a>
              <ul class="sub-menu">
                <li class="active"><a href="layout-horizontal.html"><i class="icon-energy"></i> Light</a></li>
